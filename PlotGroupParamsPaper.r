...
PlotGroupParamsPaper <- function(stocks, groups, names, phys, order, ecosystem, file.path=file.path, file.name='Compare groups', width=(3+phys*2), height=(1.5+stocks/5), usingMac=T, title.lines=rep(-2, phys)){
